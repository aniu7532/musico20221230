...
/// {@tool snippet}
///
/// This sample shows how to use a [ZzSwitch] in a [ListTile]. The
...
class ZzSwitch extends StatefulWidget {
  ...
  ///
  /// By no_data, the drag start behavior is [DragStartBehavior.start].
  ///
  /// See also:
  ///
  ...
  @override
  State<ZzSwitch> createState() => _ZzSwitchState();
...
class _ZzSwitchState extends State<ZzSwitch> with TickerProviderStateMixin {
  ...
  @override
  void didUpdateWidget(ZzSwitch oldWidget) {
    ...
    required double scale,
        ...
        super(
            additionalConstraints: BoxConstraints.tightFor(
                width: _kSwitchWidth * scale, height: _kSwitchHeight * scale)) {
    state.position.addListener(markNeedsPaint);
    state._reaction.addListener(markNeedsPaint);
  }

  final _ZzSwitchState _state;
